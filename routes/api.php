...
Route::middleware(['auth:api', 'Is_Active', 'request.safety', 'token.timeout'])->group(function () {
    ...
    Route::get('report/expiry_alert', 'ReportController@Products_Alert'); // Mapped to the new logic
    Route::get('report/stock_alert', 'ReportController@Products_Alert'); // Keep for backward compatibility if needed
    ...
    // ------------------------------- Payment Sales -----------------------\\
    Route::resource('payment/sales', 'PaymentSalesController');
    ...
    Route::post('payment_purchase/{id}/approve', 'PaymentPurchasesController@approve');
    ...
    // ------------------------------- Sales Approval --------------------------\\
    // -------------------------------------------------------------------------\\
    Route::get('sales-approval', 'SalesApprovalController@index');
    Route::get('sales-approval/{id}', 'SalesApprovalController@show');
    Route::post('sales-approval/{id}/approve', 'SalesApprovalController@approve');
    Route::post('sales-approval/{id}/reject', 'SalesApprovalController@reject');
    Route::get('sales-approval-count', 'SalesApprovalController@pendingCount');
    ...
    Route::post('payment_sale/{id}/approve', 'PaymentSalesController@approve');
    Route::post('payment_sale/{id}/reject', 'PaymentSalesController@reject');
    Route::get('payment_sales/status-history', 'PaymentSalesController@statusHistory');
