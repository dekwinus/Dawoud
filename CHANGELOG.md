...
-   Added  : Video in documentation showing you the steps on how to upgrade DawPOS
-   Updated : Minor bug fixes
...
+ DawPOS now requires PHP 8.1.0 or greater.
...
✅ Upgraded to Laravel 12 — DawPOS now requires PHP ≥ 8.2
