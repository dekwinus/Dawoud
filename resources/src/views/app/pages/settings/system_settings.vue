                    ...
                    <b-form-group label="POS receipt layout">
                      <b-form-radio-group
                        ...
                        :options="[
                          ...
                          { value: 3, text: 'Layout 3 - A5 Invoice' },
                        ]"
                        buttons
                  ...
                  <b-col lg="12" md="12" sm="12" class="mb-3">
                    <b-form-group :label="$t('Receipt_Paper_Size')">
                      ...
                      <small class="text-muted d-block mt-1">
                        {{ $t('Select_the_paper_size_for_thermal_receipts') }}
                      </small>
                    </b-form-group>
                  </b-col>
                  <!-- Live receipt demo -->
                            ...
                            <b-row v-if="backupDestination === 'cloud' && setting.backup_cloud_provider === 'dropbox'">
                              <b-col lg="6" md="6" sm="12" class="mb-3">
                                <b-form-group label="Dropbox folder path (optional)">
                                  <b-form-input v-model="setting.backup_dropbox_path" placeholder="e.g. /DawPOSBackups" />
                                </b-form-group>
                              </b-col>
                              <b-col lg="6" md="6" sm="12" class="mb-3">
