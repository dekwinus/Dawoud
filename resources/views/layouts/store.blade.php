...
<head>
  ...
  <meta name="currency" content="{{ $s->currency_code ?? 'EGP' }}">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navMain">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('store.chatbot') }}">
              <i class="bi bi-chat-dots me-1"></i>{{ __('messages.ChatAssistant') ?? 'Chat Assistant' }}
            </a>
          </li>
