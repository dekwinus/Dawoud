      ...
      <table class="table align-middle">
        ...
        <tfoot>
          <tr>
            ...
            <td class="text-end fw-semibold"><span id="subtotal-val">EGP 0.00</span></td>
            <td></td>
          </tr>
          <tr>
            <td colspan="3" class="text-end h5">{{ __('messages.GrandTotal') }}</td>
            <td class="text-end h5"><span id="grand-val">EGP 0.00</span></td>
            <td></td>
          </tr>
        </tfoot>
      </table>
...
(function(){
  ...
  const CURRENCY   = document.querySelector('meta[name="currency"]')?.content || 'EGP';
