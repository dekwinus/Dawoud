...
class ProductsController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            \DB::transaction(function () use ($request) {
                ...
                // —————— Warranty & Guarantee ——————
                $Product->production_date = $request['production_date'] ?? null;
    ...
    public function Get_Products_Details(Request $request, $id)
    {
        ...
        // ——— Warranty & Guarantee ———
        $item['production_date'] = $Product->production_date;
    ...
    public function show_product_data($id, $variant_id, $warehouse_id = null)
    {
        ...
        $item['unit_data'] = $Product_data['unit'] ? $Product_data['unit'] : null;
        ...
        $item['unit_sale_data'] = $Product_data['unitSale'] ? $Product_data['unitSale'] : null;
