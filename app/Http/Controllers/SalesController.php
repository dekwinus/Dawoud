...
class SalesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $sale = \DB::transaction(function () use ($request) {
            ...
            $order->statut = $isAdmin ? $request->statut : 'pending';
            ...
            foreach ($data as $key => $value) {
                ...
                if ($isAdmin && $order->statut == 'completed') {
            ...
            if ($isAdmin && $request->payment['status'] != 'pending') {
                ...
                try {
                    ...
                    if ($request['amount'] > 0 && $request->payment['status'] != 'pending') {
                        ...
                        $account_id = $paymentMethod ? $paymentMethod->account_id : ($request->payment['account_id'] ? $request->payment['account_id'] : null);
    ...
    public function show(Request $request, $id)
    {
        ...
        $sale_details['created_by'] = $sale_data['user']->username;
    ...
    public function Sale_PDF(Request $request, $id)
    {
        ...
        $sale['seller_name'] = $sale_data['user']->username;
